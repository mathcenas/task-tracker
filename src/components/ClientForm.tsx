...
export const ClientForm: React.FC = () => {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 relative">
      {showSuccess && (
        <div className="absolute top-4 right-4 flex items-center space-x-2 bg-green-500 text-white px-4 py-2 rounded-md border border-gray-200 dark:border-gray-700 animate-fade-in">
