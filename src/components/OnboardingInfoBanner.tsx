...
export function OnboardingInfoBanner() {
  ...
  return (
    <div className="mb-6 rounded-lg border border-cyan-200 bg-cyan-50/50 p-4 text-sm dark:border-cyan-900/30 dark:bg-cyan-950/20">
      <button
        type="button"
        onClick={() => setIsOpen(!isOpen)}
        className="flex w-full items-center justify-between font-medium text-cyan-900 dark:text-cyan-300"
      >
      ...
      {isOpen && (
        <div className="mt-3 space-y-2 text-cyan-800 dark:text-cyan-400/90 leading-relaxed">
          <p>
          ...
          <p className="text-xs italic border-t border-cyan-200/50 pt-2 dark:border-cyan-900/40">
